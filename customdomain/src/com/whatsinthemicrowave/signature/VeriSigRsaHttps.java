...
import com.whatsinthemicrowave.security.RsaHttps;

public class VeriSigRsaHttps {

	public static void main(String[] args) {
		if (args.length <2) {
			System.out.println("Usage: java " + VeriSigRsaHttps.class.getSimpleName() + " <signature> <signed file>");
			System.exit(1);
		}
		
		ApplicationContext ctx = new ClassPathXmlApplicationContext("resources/webconfig.xml");
		
		RsaHttps credential = (RsaHttps) ctx.getBean("credential");
